<template lang="pug">
  section#page-article.page-container.article-page
    main.page-content
      article.article
        h1.article__title Днепр (город)

        p.
          <strong>Днепр</strong> (<strong>Днипро́</strong>[5], укр. <em>Дніпро́</em>; до 1796 и с 1802 по 1926 — <strong>
          ...
          Днепропетро́вск</strong>, укр. <em>Дніпропетро́вськ</em>) — город, областной центр Днепропетровской области
           ...
           <a href="#">Киева</a>, <a href="#">Харькова</a> и <a href="#">Одессы</a>.
